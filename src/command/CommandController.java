...
public abstract class CommandController {
	/**
	 * Method to check all necessary components of the sentence are in place.
	 * Used to safeguard against game crashes due to badly formed sentences.
	 * Please note: the validity of the command name itself has been already checked
	 * in the CommandInstantiator class.
	 * 
